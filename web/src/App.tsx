...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/morgan', initials: 'mo', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/morgan</span> — HTTP request logger middleware, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of expressjs/morgan</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/morgan" footer={footer}>
