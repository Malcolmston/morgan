...
// the GitHub Releases API for malcolmston/morgan.
const RELEASE_LIBS: RelLib[] = [
  { name: MORGAN.name, icon: MORGAN.icon, accent: MORGAN.accent, repo: ghrepo(MORGAN), url: MORGAN.repo },
];
